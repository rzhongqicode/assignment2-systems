...
from cs336_systems.FlashAttention2 import FlashAttention2Pytorch, FlashAttention2Triton
from cs336_systems.overlap_ddp import Overlap_Wrapper, Overlap_Wrapper_bucketed
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    return Overlap_Wrapper(model=module)
    raise NotImplementedError
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return Overlap_Wrapper_bucketed(model=module, bucket_size_mb=bucket_size_mb)
    # raise NotImplementedError
